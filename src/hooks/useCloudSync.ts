...
type Props = {
  ...
  setSafeZones: Dispatch<SetStateAction<Map<ParameterKey, { min: number; max: number }>>>
  setSafeZonesBase: Dispatch<SetStateAction<Map<ParameterKey, { min: number; max: number }>>>
  setTankSettings: Dispatch<SetStateAction<Map<ParameterKey, TankParameterSetting>>>
  setSavedTankSettings: Dispatch<SetStateAction<Map<ParameterKey, TankParameterSetting>>>
  setCloudConsumptionRates: Dispatch<SetStateAction<Map<ParameterKey, number>>>
  // Storage keys (needed to read local cache)
  entriesStorageKey: string | null
  bioEntriesStorageKey: string | null
  catalogStorageKey: string | null
  lightingPhasesStorageKey: string | null
  protocolLogsStorageKey: string | null
  protocolDefinitionsStorageKey: string | null
  protocolChecksStorageKey: string | null
...
export function useCloudSync({
  ...
  return { handleGoogleLogin, handleLogout, handleRetrySync }
}
