...
-- ============================================================
-- Migração 1: user_settings + water_changes + bio_requirements enriquecidos
-- (equivalente a supabase_evolution_migrations.sql)
-- ============================================================
...
revoke all on table public.water_changes from anon;
grant select, insert, update, delete on table public.water_changes to authenticated;

-- 3. Enriquecimento de bio_requirements: dificuldade, volume mínimo, comportamento
...
-- 4. Enriquecimento de bio_requirements: compatibilidade e agressividade
ALTER TABLE public.bio_requirements
